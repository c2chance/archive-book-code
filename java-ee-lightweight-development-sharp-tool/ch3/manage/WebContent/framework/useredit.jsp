		...
		<div class="editcontent"
			...
			<div id="maindata">
				...
				<div style="display:none;">
					<input id="ICODE" type="text"> <input id="NO" type="text">
				</div>
				...
				<table class="table table-hover table-condensed">
					<tr>
						...
						</select>--%> <input id="AREAICODE" type="text"
							class="easyui-combotree span2"
							data-options="url:'AREAFindTree.action',required:true"></td>
						<th>姓名</th>
					...
					<tr>
						<th>登录账号</th>
						<td><input id="LOGINNAME" type="text"
					...
					<tr>
						<th>电子邮箱</th>
						<td colspan="3"><input id="EMAIL" type="text" class="span5"
