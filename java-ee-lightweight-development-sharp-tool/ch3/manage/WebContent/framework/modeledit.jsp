...
<head>
	...
	<script type="text/javascript" src="modeledit.js"></script>
			...
			<div id="maindata" >
				...
				<table class="table table-hover table-condensed">
					<tr>
						...
						<th>上级</th>
						<td>
						<input id="PARENTICODE" type="text" class="easyui-combotree span2" data-options="url:'MODELFindTree.action'">
						</td>
					</tr>
					<tr>
						<th>级别</th>
						<td colspan="3">
						<%--<input id="LEVEL1" type="text" class="easyui-validatebox span2" data-options="required:true">
						--%>
							<select id="LEVEL1" class="easyui-validatebox span2" >
								<option>一级菜单</option>
								<option>二级菜单</option>
								<option>具体功能菜单</option>
							</select>
						</td>
					</tr>
					<tr>
						<th>网址</th>
						<td colspan="3"><input id="URL" type="text" class="span5" style="width:322px;">
						</td>
					</tr>
				</table>
